  ...
  return (
    <>
      <section className="mt-10 grid gap-6 lg:grid-cols-3">
        <StatCard
          title="Spots sur la stations radio"
          metric={ddaData?.data?.nvd?.sector?.nombre_spots_total || 0}
          metaLabel="Derniers relevés"
          gradient
          recent={[
            {
              label: "Spots concurrence",
              channel: stationIdentifier,
              value:
        ...
        />
        <StatCard
          title="Valorisation publicitaire"
          metric={`${
          ...
          recent={[
            {
              label: "Valorisation publicitaire",
              channel: stationIdentifier,
              value:
                formatCurrency(
          ...
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs uppercase tracking-wide text-muted-foreground/70">
                Nombre de spots radio par jour
              </p>
            </div>
          </div>
          <div className="mt-6">
      ...
      <CardContent className="space-y-6 p-6">
        ...
        >
          <div className="flex items-start justify-between">
            ...
            <Radio className="h-5 w-5 text-[#f26a24]" />
          </div>
        </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-muted/60">
                    <Headphones className="h-5 w-5 text-[#0c6e85]" />
                  </div>
                  <div>
...
function SectorAnalysisSection({ datas, sector, station }) {
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              Nombre de spots radio par jour sur le secteur
            </p>
          ...
          <div className="space-y-6">
            ...
            <div className="grid gap-8 md:grid-cols-[minmax(0,1fr)]">
              <div className="mx-auto flex h-60 w-full max-w-xs items-center justify-center md:h-64">
                <ChartContainer
                  config={{
                    ...
                    station: { label: `Nombre spots ${station}`, color: "#f26a24" },
                  }}
                  className="h-full"
                >
                  <ResponsiveContainer width="100%" height="100%">
              ...
              <div className="space-y-4 text-sm text-muted-foreground">
                ...
                <div>
                  <span className="text-black">
                    En termes de valorisation, <b>{station}</b> représente{" "}
                    <b className="text-[#f26a24]">
